...
export default function OdAnalysisCharts({ data }) {
          ...
          <div style={{ width: '100%', height: 280 }}>
            <ResponsiveContainer>
              <ComposedChart data={byGroup.get(g)} margin={{ top: 30, right: 20, bottom: 0, left: 0 }}>
                ...
                <YAxis yAxisId="right" orientation="right" label={{ value: 'OD', angle: -90, position: 'insideRight' }} />
                <Tooltip />
                <Legend />
                ...
                <Line yAxisId="right" type="monotone" dataKey="od" name="OD" stroke="#f59e0b" strokeWidth={2} dot>
                  <LabelList content={<ODLabel />} />
                </Line>
              </ComposedChart>
            </ResponsiveContainer>
          </div>
