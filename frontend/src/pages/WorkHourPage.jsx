...
import WorkHourCharts from '../components/WorkHourCharts'
...
export default function WorkHourPage() {
  ...
  const { data = [], isLoading, isError, error } = useQuery({ queryKey: ['work_hour', baseKey], queryFn: () => getWorkHourCompletion(baseKey), retry: 0 })
